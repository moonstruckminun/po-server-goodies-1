...
function mafiaChecker() {
    ...
    var theme,
        ...
        noFatal,
        globalStats,
        possibleNightActions = ["kill", "protect", "bomb", "dayprotect", "daydistract", "inspect", "distract", "poison", "safeguard", "stalk", "watch", "convert", "curse", "copy", "indoctrinate", "detox", "dispel", "shield", "guard", "massconvert", "disguise", "redirect", "memory", "dummy", "dummy2", "dummy3", "dummy4", "dummy5", "dummy6", "dummy7", "dummy8", "dummy9", "dummy10" ],
                ...
                if (checkType(role.actions.night, ["object"], act + ".night")) {
                    for (e in role.actions.night) {
                        ...
                        if (checkType(action, ["object"], comm)) {
                            ...
                            if (commandList.indexOf("memory") !== -1)
